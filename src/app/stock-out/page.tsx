              ...
              <table className="w-full text-sm sm:text-base">
                <thead>
                  <tr className="bg-gradient-to-r from-gray-50/80 to-gray-100/80 border-b border-gray-200/50">
                    ...
                    <th className="text-left px-2 sm:px-6 py-2 sm:py-4 font-semibold text-gray-700 text-xs sm:text-sm">Stok Awal</th>
                    <th className="text-left px-2 sm:px-6 py-2 sm:py-4 font-semibold text-gray-700 text-xs sm:text-sm">Sisa Stok (Sore)</th>
                  </tr>
                </thead>
                    ...
                    <tr>
                      <td colSpan={3} className="px-3 sm:px-6 py-8 sm:py-12 text-center">
                        <div className="flex flex-col items-center space-y-2 sm:space-y-3">
                          ...
                          <div>
                            <p className="text-gray-500 font-medium text-sm sm:text-base">Tidak ada data stok pagi untuk tanggal ini</p>
                            <p className="text-xs sm:text-sm text-gray-400">Silakan input stok pagi terlebih dahulu</p>
                          </div>
                        </div>
                      </td>
                    </tr>
